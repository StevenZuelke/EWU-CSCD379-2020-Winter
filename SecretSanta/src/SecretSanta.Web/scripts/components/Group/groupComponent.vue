        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr v-for="group in groups" v-bind:id="group.id">
                    ...
                    <td>{{group.title}}</td>
                    <td>
                        <button class="button is-light" @click='setGroup(group)'>Edit</button>
                        <button class="button is-primary" @click='deleteGroup(group)'>Delete</button>
                    </td>
                </tr>

            </tbody>
        </table>
        <group-details-component v-if="this.selectedGroup != null"
