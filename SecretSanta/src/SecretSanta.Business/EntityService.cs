...
namespace SecretSanta.Business
{
        ...
        where TEntity : EntityBase
    {
        ...
        virtual public Task<bool> DeleteAsync(int id)
        {
        ...
        virtual public async Task<TEntity[]> InsertAsync(params TEntity[] entities)
        {
        ...
        virtual public async Task<TEntity> UpdateAsync(int id, TEntity entity)
        {
